...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<div class="container-fluid">
		<a class="navbar-brand" href="../views/index.jsp"><svg
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					<li class="nav-item"><a class="nav-link"
						href="../servlet/Product.action">商品</a></li>
					<li class="nav-item"><a class="nav-link"
						href="../views/cart.jsp">カート</a></li>
					<li class="nav-item"><a class="nav-link"
						href="../servlet/Preview.action">購入</a></li>
					<li class="nav-item"><a class="nav-link"
						href="../views/login-in.jsp">ログイン</a></li>
					<li class="nav-item"><a class="nav-link"
						href="../views/logout-in.jsp">ログアウト</a></li>
				</ul>
